...
class SendTextController < ApplicationController
	...
	def home
		...
		girlfriend_okcupid_foundsomeoneelse = person+", there's plenty of fish in the sea, huh?  I know it's a cliche but there's truth in it. You never know who is coming up around the bend. See, after the last time we met up, I ran into my college professor. She was my favorite, just the smartest woman you've ever heard talk about the history of the French revolution. Anyways, it turns out she recently divorced, her husband left her for a library sciences professor. Long story short, we're in love. I know it seems sudden but life is sudden like that, you know? Anyways, best of luck finding your fish. -"+fromname
